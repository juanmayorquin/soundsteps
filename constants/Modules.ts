...
export const MODULES: ModuleConfig[] = [
  {
    ...
    description: 'Identifica si puedes escuchar un sonido. Ejercicios sí/no para entrenar tu percepción auditiva.',
    icon: 'notifications',
    iconBg: '#dbeafe',
  ...
  },
  {
    ...
    description: 'Compara dos sonidos y decide si son iguales o diferentes.',
    icon: 'graphic-eq',
    iconBg: '#ccfbf1',
    iconColor: '#0d9488',
    tagLabel: 'Intermedio',
  ...
  },
  {
    ...
    description: 'Escucha una palabra y selecciona la imagen correcta entre las opciones.',
